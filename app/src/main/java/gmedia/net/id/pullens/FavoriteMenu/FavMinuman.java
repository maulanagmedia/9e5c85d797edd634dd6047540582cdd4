...
public class FavMinuman extends Fragment {
    ...
    private View layout;
    private static ListView lvMinuman;
    private static int startIndex = 0;
    private static int count = 10;
    public static String keyword = "";
    private static List<CustomItem> listMinuman;
    private static ProgressBar pbMinuman;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        layout = inflater.inflate(R.layout.fragment_fav_minuman, container, false);
        context = getContext();
        initUI();
        return layout;
    }
    ...
    private void initUI() {
        ...
        lvMinuman = (ListView) layout.findViewById(R.id.lv_minuman);
        pbMinuman = (ProgressBar) layout.findViewById(R.id.pb_minuman);
    ...
    public static void getServer() {
        ...
        pbMinuman.setVisibility(View.VISIBLE);
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if(iv.parseNullInteger(status) == 200){
                        ...
                        pbMinuman.setVisibility(View.GONE);
                    }
                ...
                try {
                    ...
                    if(iv.parseNullInteger(status) == 200){
                        ...
                        for(int i = 0; i < jsonArray.length(); i++){
                            ...
                            listMinuman.add(new CustomItem(jo.getString("id"), jo.getString("nama"), jo.getString("harga"), jo.getString("gambar"), jo.getString("keterangan"),  jo.getString("timestamp"), jo.getString("total_rating")));
                        }
                    }

                    setHomeMenuAdapter(listMinuman);
                    pbMinuman.setVisibility(View.GONE);
                    btnRefresh.setVisibility(View.GONE);
                } catch (JSONException e) {
                    e.printStackTrace();
    ...
    private static void setHomeMenuAdapter(List<CustomItem> listItem){
        ...
        isDialogOpen = false;
        lvMinuman.setAdapter(null);

        if(listItem != null && listItem.size() > 0){

            homeMenuAdapter = new ListHomeMenuAdapter((Activity) context, listItem);
            lvMinuman.setAdapter(homeMenuAdapter);

            lvMinuman.setOnScrollListener(new AbsListView.OnScrollListener() {
                @Override
                public void onScrollStateChanged(AbsListView absListView, int i) {

                    int threshold = 1;
                    int count = lvMinuman.getCount();

                    if (i == SCROLL_STATE_IDLE) {
                        if (lvMinuman.getLastVisiblePosition() >= count - threshold && !isLoading) {

                            isLoading = true;
                            lvMinuman.addFooterView(footerList);
                            startIndex += count;
                            getMoreData();
                        }
                    }
        ...
        lvMinuman.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if(iv.parseNullInteger(status) == 200){
                        ...
                        lvMinuman.removeFooterView(footerList);
